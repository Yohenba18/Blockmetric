      ...
      <Layout>
        <div className="text-white my-10 mx-5 md:mx-20">
          ...
          <p>
            ...
            use of BlockMetric's Website, located at BlockMetric.tech.`}
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use BlockMetric if you do not agree
          ...
          <h3 className="text-base font-bold my-5">
            <strong>Cookies</strong>
          </h3>

          <p>
            {`We employ the use of cookies. By accessing BlockMetric, you agreed
            to use cookies in agreement with the BlockMetric's Privacy Policy.`}{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, BlockMetric and/or its licensors own the
            intellectual property rights for all material on BlockMetric. All
            intellectual property rights are reserved. You may access this from
            BlockMetric for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from BlockMetric</li>
            <li>Sell, rent or sub-license material from BlockMetric</li>
            <li>Reproduce, duplicate or copy material from BlockMetric</li>
            <li>Redistribute content from BlockMetric</li>
          </ul>
          ...
          <p>
            ...
            BlockMetric does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of BlockMetric,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            BlockMetric shall not be liable for the Comments or for any
          ...
          <p>
            BlockMetric reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant BlockMetric a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of BlockMetric;
          ...
          <p>
            ...
            sending an e-mail to BlockMetric. Please include your name, your
          ...
          <p>
            {`No use of BlockMetric's logo or other artwork will be allowed for
