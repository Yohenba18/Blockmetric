    ...
    <>
      ...
      <div>
        ...
        >
          ...
          {showResouces ? (
            <ChevronUpIcon className="absolute right-5 h-6 w-6 transform-gpu transition-transform hover:scale-125 active:scale-90" />
          ) : (
            <ChevronDownIcon className="absolute right-5 h-6 w-6 transform-gpu transition-transform hover:scale-125 active:scale-90" />
          )}
        </button>
        {showResouces && (
          <Resources
